...
fn check_verifier_date_1() {
    let test_struct = Testing { data: "".to_string()};
    ...
    let test_struct = Testing { data: "01-01-2022".to_string()};
    let mut to_verify =  test_struct.data.clone();
    ...
    let test_struct = Testing { data: "2022-01-01".to_string()};
    let mut to_verify =  test_struct.data.clone();
    ...
    let test_struct = Testing { data: "2022-01".to_string()};
    let mut to_verify =  test_struct.data.clone();
...
fn check_verifier_date_2() {
    let test_struct = Testing { data: "2022-01-0".to_string()};
    let mut to_verify =  test_struct.data.clone();
    ...
    let test_struct = Testing { data: "2022-0-01".to_string()};
    let mut to_verify =  test_struct.data.clone();
    ...
    let test_struct = Testing { data: "202-01-01".to_string()};
    let mut to_verify =  test_struct.data.clone();
...
fn check_verifier_date_3() {
    let test_struct = Testing { data: "2022-01-32".to_string()};
    let mut to_verify =  test_struct.data.clone();
    ...
    let test_struct = Testing { data: "2022-02-31".to_string()};
    let mut to_verify =  test_struct.data.clone();

    let result = test_struct.verify_date(&mut to_verify).unwrap();
    let expected_data = "Date: Date not acceptable and possibly non-existing. Error: input is out of range".to_string();
    assert_eq!(result, expected_data);

    let test_struct = Testing { data: "2022-13-31".to_string()};
    let mut to_verify =  test_struct.data.clone();
    ...
    let test_struct = Testing { data: "2026-01-31".to_string()};
    let mut to_verify =  test_struct.data.clone();
