...
pub fn verify_date(user_date: &mut String) -> Result<String, Box<dyn Error>> {
...
pub fn verify_amount(amount: &mut String) -> Result<String, Box<dyn Error>> {
...
pub fn verify_tx_type(tx_type: &mut String) -> Result<String, Box<dyn Error>> {
